...
class RecFunSuite extends munit.FunSuite:
  ...
  test("countChange: list with 3 elements") {
    assertEquals(countChange(11, List(7, 5, 3)), 1)
  }

  test("countChage: list with 4 elements") {
    assertEquals(countChange(11, List(7, 5, 1, 3)), 10)
  }
